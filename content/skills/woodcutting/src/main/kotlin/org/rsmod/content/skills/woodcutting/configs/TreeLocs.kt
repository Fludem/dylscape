...
internal object WoodcuttingTrees : LocEditor() {
    init {
        ...
        // Tutorial Island's own trees. They are ordinary trees with their own models, and the
        // island carries no stump loc of its own, so they fall back to the standard stump.
        regular(trees.newbie_tree, stumps.regular_stump_1342)
        regular(trees.newbie_tree2, stumps.regular_stump_1342)
        dead(trees.newbie_deadtree, stumps.dead_stump_1347)
        dead(trees.newbie_deadtree2, stumps.dead_stump_1347)
        oak(trees.newbie_oaktree, stumps.oak_stump_1356)
...
internal object TreeLocs : LocReferences() {
    ...
    val newbie_tree = find("newbietree")
    val newbie_tree2 = find("newbietree2")
    val newbie_deadtree = find("newbiedeadtree")
    val newbie_deadtree2 = find("newbiedeadtree2")
    val newbie_oaktree = find("newbieoaktree")
