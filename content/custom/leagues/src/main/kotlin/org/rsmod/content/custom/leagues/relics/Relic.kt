...
enum class Relic(
    ...
    FriendlyForager(
        1,
        2,
        league_structs.friendly_forager,
        "Friendly Forager",
        true,
        league_objs.foragers_pouch,
    ),
    DodgyDeals(1, 3, league_structs.dodgy_deals, "Dodgy Deals", true),
    ClueCompass(2, 1, league_structs.clue_compass, "Clue Compass", true, league_objs.clue_compass),
    BankHeist(2, 2, league_structs.bank_heist, "Bank Heist", true, league_objs.bankers_briefcase),
    FairysFlight(
        2,
        3,
        league_structs.fairys_flight,
        "Fairy's Flight",
        true,
        league_objs.fairy_mushroom,
    ),
    GoldenGod(3, 1, league_structs.golden_god, "Golden God", true),
    Reloaded(3, 2, league_structs.reloaded, "Reloaded", true),
    Equilibrium(3, 3, league_structs.equilibrium, "Equilibrium", true),
    TreasureArbiter(4, 1, league_structs.treasure_arbiter, "Treasure Arbiter", true),
    ProductionMaster(4, 2, league_structs.production_master, "Production Master", true),
    ...
    PocketKingdom(
        6,
        1,
        league_structs.pocket_kingdom,
        "Pocket Kingdom",
        true,
        league_objs.pocket_kingdom,
    ),
    Grimoire(6, 2, league_structs.grimoire, "Grimoire", true, league_objs.arcane_grimoire),
    Overgrown(6, 3, league_structs.overgrown, "Overgrown", true, league_objs.leprechauns_vault),
    Specialist(7, 1, league_structs.specialist, "Specialist", true),
    Guardian(7, 2, league_structs.guardian, "Guardian", true, league_objs.guardian_horn),
