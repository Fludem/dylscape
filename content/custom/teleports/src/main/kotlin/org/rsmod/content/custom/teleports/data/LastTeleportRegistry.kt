...
/**
 * The last place each online player teleported to, backing the menu's "Previous" row.
 *
 ...
 * the table degrades to `null` -- "no previous destination" -- which the menu already handles.
 */
@Singleton
