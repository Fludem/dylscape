...
object ShopObjs : ObjReferences() {
    ...
    // Dwarven Mine and Brimhaven shops. Grouped by nothing but the alphabet: most of these
    // are shared by several shops, so a per-shop grouping would repeat them.
