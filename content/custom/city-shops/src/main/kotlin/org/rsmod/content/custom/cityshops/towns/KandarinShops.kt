...
internal object KandarinShopsInvs : InvEditor() {
    init {
        ...
        edit(shop_invs.archeryshop2) {
            ...
            stock += stock(shop_objs.steel_arrow, count = 0, restockCycles = 1000)
            stock += stock(shop_objs.mithril_arrow, count = 0, restockCycles = 2000)
            stock += stock(objs.adamant_arrow, count = 0, restockCycles = 3000)
            stock += stock(objs.rune_arrow, count = 0, restockCycles = 4000)
        ...
        edit(shop_invs.fishingshop2) {
            ...
            stock += stock(shop_objs.raw_sardine, count = 0, restockCycles = 600)
            stock += stock(objs.raw_herring, count = 0, restockCycles = 900)
            stock += stock(shop_objs.raw_mackerel, count = 0, restockCycles = 1000)
            stock += stock(shop_objs.raw_cod, count = 0, restockCycles = 1100)
